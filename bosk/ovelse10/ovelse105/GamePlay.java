...
public class GamePlay {
	...
	//L isten fighttypes gemmer historik over hvilke typer af spillere (Thief, Wizard, etc) der har kæmpet mod hinanden.
	...
	public static void main(String[] args) {
		...
		Warrior w1  = GameUtil.fightDirty(knud, svend);
		...
		Wizard w2 = GameUtil.fightDirty(merlin, andrew);
		...
		Magician m = GameUtil.fightMagical(jadis, merlin);
		...
		Mortal mort = GameUtil.fightDirty(y, svend);
